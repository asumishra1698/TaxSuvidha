                ...
                {services.map((service) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="rounded-2xl border border-gray-200 bg-gray-50 px-3 py-2 text-xs font-semibold text-gray-500 dark:border-gray-700 dark:bg-slate-800 dark:text-gray-300">
                        {service.turnaround}
                      </div>
                    </div>
